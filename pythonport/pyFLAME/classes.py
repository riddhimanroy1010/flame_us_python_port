...
class vehicleClass():
    ...
    def vehicle_hist_fc_f(self, first_yr = None, last_yr = None, fc_ev_mdl = None, fc_conv_mdl = None):
        ...
        if self.technology == "ICEV-G" or "ICEV-D":
            epa_fc                              = FLAME.get_input("epa_fleet_fc_hist")
            ...
            fc_ev_hist_fc                       = FLAME.get_input("fc_ev_hist")   
            ...
            #Inputs
            fe_vision                           = FLAME.get_input("vision_fe_hist")
            degra_fac                           = FLAME.get_input("fc_degra_factor_vision")
            vh_techno                           = FLAME.get_input("model_matching_technology'")
            fuel_conv                           = FLAME.get_input("fuel_conversion")
            conv                                = FLAME.get_input("conversion_units")
    ...
    def vehicle_hist_material_composition_f(self, first_yr = None, last_yr = None):
        ...
        #Inputs
        material_dt                             = FLAME.get_input("model_matching_material")
        hist_mc                                 = FLAME.get_input("fleet_mt_comp_hist")
